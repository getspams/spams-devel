...
class Ui_DictWindow(object):
    def setupUi(self, DictWindow):
        DictWindow.setObjectName("DictWindow")
        ...
        self.DVClose.setObjectName("DVClose")
        ...
        self.DVHelp.setObjectName("DVHelp")
