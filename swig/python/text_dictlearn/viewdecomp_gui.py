...
class Ui_DecompWindow(object):
    def setupUi(self, DecompWindow):
        DecompWindow.setObjectName("DecompWindow")
        ...
        self.DDClose.setObjectName("DDClose")
        ...
        self.DDHelp.setObjectName("DDHelp")
        ...
        self.VDframe.setObjectName("VDframe")
