...
%typecheck(SWIG_TYPECHECK_DOUBLE_ARRAY, fragment="DSp_Check")
...
%typemap(freearg) (AbstractMatrixB<DATA_TYPE> *INPLACE_DSPMATRIX)
{
	delete arg$argnum;
}
...
%typemap(freearg) (std::vector<StructNodeElem<DATA_TYPE> *> *TREE)
{
