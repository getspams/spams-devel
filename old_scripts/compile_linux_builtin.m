...
%setenv('optim_flag','CXXOPTIMFLAGS=-O3 -DNDEBUG -mtune=core2 -fomit-frame-pointer -funsafe-loop-optimizations -DUSE_MATLAB_LIB');
% for version >= R2009b,
...
fprintf(fid,'export LD_LIBRARY_PATH=$LIB_GCC \n');
...
mex -v -Ilinalg/ -Idecomp/ decomp/mex/mexOMP.cpp  -outdir build/ -largeArrayDims  -L/usr/lib/ -lmwblascompat32 -lgomp '$optim_flag -fopenmp'
