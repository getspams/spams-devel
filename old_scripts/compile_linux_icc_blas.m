...
setenv('link_mkl','-lblas -llapack');
setenv('optim_flag','CXXOPTIMFLAGS=-axSSE3,SSE4.1,SSE4.2,AVX -fPIC -pipe -w -w0 -fast -fomit-frame-pointer -DNDEBUG -openmp -parallel -fno-alias -ffunctions-sections -fdata-sections -fp-model fast -funroll-loops -ansi-alias -cxxlib-gcc');
...
mex  -Ilinalg/ linalg/mex/mexCalcXtY.cpp  -outdir build/ -largeArrayDims  -L/usr/lib/ -L'$path_icc'  '$optim_flag' '$link_mkl' 'CXX=$comp_icc' -liomp5 
...
mex  -Ilinalg/ -Idecomp/ decomp/mex/mexLasso.cpp  -outdir build/ -largeArrayDims  -L/usr/lib/ -L'$path_icc'  '$optim_flag' '$link_mkl' 'CXX=$comp_icc' -liomp5 
